...
} = useQuestionGeneration(projectId, taskSettings, getQuestionList, () => questions.value.data || []);
...
const handleBatchGenerate = () => {
  handleBatchGenerateAnswers(selectedQuestions.value);
};
...
.filter-wrapper {
  ...
  margin-top: -16px; /* 抵消 el-tab-pane 的默认 padding */
  margin-left: -20px;
  margin-right: -20px;
}
